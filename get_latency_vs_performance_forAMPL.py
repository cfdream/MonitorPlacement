    ...
    def get_result(self, raw_fname):
        ...
        for line in lines:
            ...
            if match != None:
                ...
                elif ith_match % each_output_num_match == 8:
                    pair_max_latency = int(match.group(1))
                ...
                if ith_match % each_output_num_match == (each_output_num_match-1):
                    ...
                    node_flow_num_vs_performance[max_node_flows].append(
                        (num_nodes, num_tasks, num_pairs, latency, flow_avg_latency, num_candidate_pairs, pair_max_latency)
                    )
        ...
        for max_node_flows, tuples in sorted(node_flow_num_vs_performance.items(), key=lambda item: item[0]):
            ...
            for one_tuple in tuples:
                ...
                list_pair_max_latency.append(one_tuple[6])
            ...
            avg_pair_max_latency = statistics.mean(list_pair_max_latency)
            stdv_num_tasks = 0
            stdv_num_candidate_pairs = 0
            stdv_num_pairs = 0
            stdv_latency = 0
            stdv_flow_avg_latency = 0
            stdv_pair_max_latency = 0
            if len(tuples) > 1:
                ...
                stdv_pair_max_latency = statistics.stdev(list_pair_max_latency)
            print(max_node_flows, avg_num_tasks, stdv_num_tasks, avg_num_candidate_pairs, stdv_num_candidate_pairs, avg_pair_max_latency, avg_num_pairs, stdv_num_pairs, avg_latency, stdv_latency, avg_flow_avg_latency, stdv_flow_avg_latency) 
